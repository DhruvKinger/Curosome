...
namespace testingemailverification.Areas.ADMIN.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "did,DepartmentName,HOD")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "did,DepartmentName,HOD")] Department department)
        {
            if (ModelState.IsValid)
            {
